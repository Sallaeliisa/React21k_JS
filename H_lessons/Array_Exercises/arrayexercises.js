...
fourthArray.forEach((el) => {
    return reversedArray.unshift(el);
})
...
for (let i = 0; i < fifthArray.length; i++) {
    if (uniqueArray.indexOf(fifthArray[i]) == -1) {
...
let compare6to7 = false;
sixthArray.forEach((i) => {
    if (seventhArray.includes(sixthArray[i]) && sixthArray.lenght == seventhArray.lenght) {
        compare6to7 = true;
    }
    console.log(compare6to7);
})
...
let compare8to9 = false;
eighthArray.forEach((i) => {
    if (ninthArray.includes(eighthArray[i]) && eighthArray.lenght == ninthArray.lenght) {
        compare8to9 = true;
    }
    console.log(compare8to9);
})
...
let names = peopleInfo.filter((el) => {
    return !(el.includes("0") || el.includes("@"));
})

let phones = peopleInfo.filter((el) => {
    return (el.includes("0"));
})

let emails = peopleInfo.filter((el) => {
    return el.includes("@");
})
